...
const DouyinAPI = {
    ...
    async saveConfig(config) {
        const response = await fetch('/api/live-chat/config/updateConfig/douyin', {
            method: 'POST',
     ...
     */
    async connect() {
        const response = await fetch('/api/live-chat/connect/douyin', {
            method: 'POST'
        });
     ...
     */
    async disconnect() {
        const response = await fetch('/api/live-chat/disconnect/douyin', {
            method: 'POST'
        });
     ...
     */
    async reconnect() {
        const response = await fetch('/api/live-chat/reconnect/douyin', {
            method: 'POST'
        });
     ...
     */
    async getStatus() {
        const response = await fetch('/api/live-chat/status/douyin');
    ...
    async batchConnect(roomIds) {
        const response = await safeFetch('/client/multiply/batch-connect?platform=douyin', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    async getBatchStatus() {
        const response = await fetch('/client/multiply/batch-status?platform=douyin');
        const result = await response.json();
    ...
    async disconnectRoom(roomId) {
        const response = await fetch(`/client/multiply/batch-disconnect?roomId=${roomId}&platform=douyin`, {
            method: 'POST'
        });
    ...
    async disconnectAllRooms() {
        const response = await fetch('/client/multiply/batch-disconnect-all?platform=douyin', {
            method: 'POST'
        });
    ...
    async fetchDisplayId() {
        const response = await safeFetch('/api/live-entry/fetch-display-id?platform=douyin', {
            method: 'POST'
        });
        const result = await response.json();
        if (result.success) {
